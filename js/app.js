...
import { setupAuthListeners, updateAuthUI, initLocationDropdowns } from './features/auth.js?v=6';
import { setupCartListeners, handleFirebaseCartSync } from './features/cart.js?v=6';
import { setupShopListeners, renderCategoryTabs, renderProducts } from './features/shop.js?v=6';
import { setupAdminListeners, setupAdminOrderListeners, toggleAdminMode } from './features/admin.js?v=6';
import { setupSearchListeners } from './features/search.js?v=6';
import { renderInvoicePage, cleanupInvoiceView } from './features/invoice.js?v=6';
import { initRouting } from './features/router.js?v=6';
import { initTracking } from './features/tracking.js?v=6';

import { getTrueDistrict } from './features/cart.js?v=6'; // Needed globally locally by forms
